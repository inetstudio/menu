...
namespace InetStudio\Menu\Http\Requests\Back;
 ...
 */
class SaveMenuRequest extends FormRequest implements SaveMenuRequestContract
{
    /**
    ...
    public function rules(Request $request): array
    {
        return [
            ...
            'alias' => 'required|max:255|unique:menus,alias,'.$request->get('menu_id'),
        ];
    }
}
