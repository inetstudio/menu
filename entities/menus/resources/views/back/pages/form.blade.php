...
@section('content')
    ...
    @push('breadcrumbs')
        @include('admin.module.menus-package.menus::back.partials.breadcrumbs.form')
    @endpush

    <div class="wrapper wrapper-content">
        <div class="ibox">
            <div class="ibox-title">
                <a class="btn btn-sm btn-white" href="{{ route('back.menus-package.menus.index') }}">
        ...
        {!! Form::open(['url' => (!$item->id) ? route('back.menus-package.menus.store') : route('back.menus-package.menus.update', [$item->id]), 'id' => 'mainForm', 'enctype' => 'multipart/form-data']) !!}
            ...
            <div class="ibox">
                <div class="ibox-title">
                    {!! Form::buttons('', '', ['back' => 'back.menus-package.menus.index']) !!}
                </div>
                                                            ...
                                                            @if (isset($tree) && count($tree) > 0)
                                                                <ol class="dd-list">
                                                                    @foreach ($tree as $item)
                                                                        @include('admin.module.menus-package.items::back.partials.tree.menu', $item)
                                                                    @endforeach
                                                                </ol>
                                                            @else
                                                                <ol class="dd-list">
    ...
    @include('admin.module.menus-package.items::back.modals.add_menu_item')
@endsection
