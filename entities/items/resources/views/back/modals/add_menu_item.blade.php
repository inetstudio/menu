@pushonce('modals:add_item_modal')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::dropdown('menu_item', [], [
                        ...
                        'options' => [
                            'values' => array_merge([null => ''], (config('menus_package_menus.menuable')) ? collect(config('menus_package_menus.menuable'))->mapWithKeys(function ($item) {
                                return [$item['type'] => $item['title']];
                            })->toArray() : [],[
                                'link' => 'Ссылка',
                                'separator' => 'Разделитель',
                            ]),
                            'attributes' => (config('menus_package_menus.menuable')) ? collect(config('menus_package_menus.menuable'))->mapWithKeys(function ($item) {
                                return [
                                    $item['type'] => [
